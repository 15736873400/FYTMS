			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<form action="${pageContext.request.contextPath }/post4/searchTraveller">  
		<input type="text" name="passportNo" placeholder="请输入用户护照号" /><br />
...
<!-- &nbsp&nbsp&nbsp --><input style="width:100px"  type="submit"  class="btn btn-xs btn-danger"/><br/><br/>
				...
				<tr>
					...
					<td>${list.travelName }</td>
						<td>${list.trPort }</td>
					<td><a href="${pageContext.request.contextPath }/post4/searchAllShip/${list.passportNo }"><input type="submit" class="layui-btn"  value="订票"></a>
						
	<a href="${pageContext.request.contextPath }/post4/showChangeTicket/${list.passportNo }"><input type="submit" class="layui-btn"  value="改签"></a>
	</td>
				</tr>
			</c:forEach>
			</tbody>
