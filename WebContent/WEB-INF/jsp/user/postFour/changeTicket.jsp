...
<%@include file="../postSix/postSix.jsp" %>
				...
				<th>到达港口</th>
												...
												<tbody>
												<c:forEach items="${sl}" var="sl" varStatus="loop">
				<tr>
					<td>${sl.tickNo }</td>
					<td>${sl.shiptimeNo }</td>
					<td>${tickDateList[loop.count-1] }</td>
					<td>${sl.shipNo }</td>
					<td>${sl.startPort }</td>
					...
					<td><a
						href="${pageContext.request.contextPath }/post4/searchShip2/${sl.passportNo}/${sl.tickNo}">
							<input type="submit"   class="layui-btn"  value="改签">
					</a></td>
				</tr>
			</c:forEach>
			</tbody>
