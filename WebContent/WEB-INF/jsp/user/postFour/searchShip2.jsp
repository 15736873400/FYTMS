...
<link href="${pageContext.request.contextPath }/assets/css/bootstrap.min.css" rel="stylesheet" />
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/layui.css" /><link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/ace-skins.min.css" />
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<!-- /.nav-list -->
<%@include file="../postSix/postSix.jsp" %>
...
laydate.render({
  elem: '#test1' //指定元素
						...
						<form action="${pageContext.request.contextPath }/post4/searchShip/${passportNo}">  
		请${passportNo}选择登船日期：<input type="text" id="test1" name="dPort"><br />
		<br/>选择起始港口：<select name="startPort">
			<c:forEach items="${portList}" var="pl">
				<option value="${pl.idt_dic_port }">${pl.dPort }</option>
			</c:forEach>
		</select><br />
		选择到达港口：<select name="arrPort">
			<c:forEach items="${portList}" var="pl">
				<option value="${pl.idt_dic_port }">${pl.dPort }</option>
			</c:forEach>
		</select><br /> 
		<input style="width:100px"  type="submit"  class="btn btn-xs btn-danger" value="查询">
		</form> 
						<div class="col-xs-12">
				...
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath }/post4/addTicket/${passportNo }/${list.shiptimeNo}">
							<input class="layui-btn"  type="submit" value="开始订购">
					</a></td>
				</tr>
			</c:forEach>
			</tbody>
